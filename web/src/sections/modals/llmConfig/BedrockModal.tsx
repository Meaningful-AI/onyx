      ...
      <InputLayouts.FieldPadder>
        <Section gap={1}>
          ...
          <InputLayouts.Vertical
            ...
            subDescription="Choose how PHX Holdings should authenticate with Bedrock."
          >
            <InputSelect
      ...
      {authMethod === AUTH_METHOD_IAM && (
        <InputLayouts.FieldPadder>
          <Card background="none" border="solid" padding="sm">
            <Content
              icon={SvgAlertCircle}
              title="PHX Holdings will use the IAM role attached to the environment it’s running in to authenticate."
              variant="body"
              sizePreset="main-ui"
            />
          </Card>
