...
export default function OpenEmbeddingPage({
  ...
  return (
    <div>
      ...
      <Text as="p">
        {markdown(
          "**NOTE:** not all models listed will work with PHX Holdings, since some have unique interfaces or special requirements. If in doubt, reach out to the PHX Holdings team."
        )}
      </Text>
      {!configureModel && (
