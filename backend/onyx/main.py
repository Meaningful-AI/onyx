...
from onyx.server.manage.query_log import router as query_log_router
from onyx.server.manage.search_settings import router as search_settings_router
from onyx.server.manage.slack_bot import router as slack_bot_management_router
from onyx.server.manage.usage_stats import router as usage_stats_router
...
def get_application(lifespan_override: Lifespan | None = None) -> FastAPI:
    ...
    include_router_with_global_prefix_prepended(application, query_log_router)
    include_router_with_global_prefix_prepended(application, usage_stats_router)
    include_router_with_global_prefix_prepended(
